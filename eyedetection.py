...
face_cascade = cv2.CascadeClassifier('D:\TY ET A\SDP\DrowsyDriverDetection\Haar\haarcascade_frontalface_default.xml')
eye_cascade_left = cv2.CascadeClassifier('D:\TY ET A\SDP\DrowsyDriverDetection\Haar\haarcascade_eye_tree_eyeglasses.xml')
eye_cascade_right = cv2.CascadeClassifier('D:\TY ET A\SDP\DrowsyDriverDetection\Haar\haarcascade_righteye_2splits.xml')
def help_message():
...
def skeleton_tracker1(v, file_name):
    ...
    while(1):
        ...
        output_name = "Output/"+sys.argv[2]+str(frameCounter)+".jpg"
